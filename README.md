...
- 💻 **HTML Essentials Certificate of Completion** – Cisco Networking Academy 
  📄 [View Certificate](./html_cert.png)

- 💻 CSS Essentials Certificate of Completion  – Cisco Networking Academy
  📄[View Certification](./css_cert.png)
...
- 💻 Python Essentials 2 Certificate of Completion  – Cisco Networking Academy
  📄[View Certification](./py2_cert.png)


## 👩‍💻🏵️ 𝐁𝐀𝐃𝐆𝐄𝐒 🏵️👩‍💻

- 💻 **HTML Essentials Verified** – Cisco Networking Academy 
  🏵️ [View Badge](./html_badge.png)
  
- 💻 **CSS Essentials Verified** – Cisco Networking Academy 
  🏵️ [View Badge](./css_badge.png)

- 💻 **Python Essentials 11 Verified** – Cisco Networking Academy 
  🏵️ [View Badge](./py1_badge.png)

- 💻 **Python Essentials 2 Verified** – Cisco Networking Academy 
